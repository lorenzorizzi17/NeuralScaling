...
\subsection{Ridge case}
	\begin{itemize}
		\item Add the ridge parameter $\lambda$ and verify this is equivalent to $l(\kappa)$
		\item Reinterpret everything in terms of $\lambda_{eff}$, higher terms act as a regularizer
	\end{itemize}
